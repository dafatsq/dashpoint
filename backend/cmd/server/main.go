...
func setupRoutes(
	...
	users.Post("/", middleware.RequireAnyPermission(permissionChecker, "can_create_user", "can_create_manager_users", "can_create_cashier_users"), userHandler.Create)
	users.Patch("/:id", middleware.RequireAnyPermission(permissionChecker, "can_edit_user", "can_edit_manager_users", "can_edit_cashier_users"), userHandler.Update)
	users.Patch("/:id/password", middleware.RequireAnyPermission(permissionChecker, "can_edit_user", "can_edit_manager_users", "can_edit_cashier_users"), userHandler.UpdatePassword)
	users.Patch("/:id/pin", middleware.RequireAnyPermission(permissionChecker, "can_edit_user", "can_edit_manager_users", "can_edit_cashier_users"), userHandler.UpdatePIN)
	users.Delete("/:id", middleware.RequireAnyPermission(permissionChecker, "can_delete_user", "can_delete_manager_users", "can_delete_cashier_users"), userHandler.Delete)
	users.Delete("/:id/permanent", middleware.RequireAnyPermission(permissionChecker, "can_delete_user", "can_delete_manager_users", "can_delete_cashier_users"), userHandler.PermanentDelete)
