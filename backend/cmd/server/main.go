...
func setupRoutes(
	...
	users.Post("/", middleware.RequirePermission(permissionChecker, "can_manage_users"), userHandler.Create)
	users.Patch("/:id", middleware.RequirePermission(permissionChecker, "can_manage_users"), userHandler.Update)
	users.Patch("/:id/password", middleware.RequirePermission(permissionChecker, "can_manage_users"), userHandler.UpdatePassword)
	users.Patch("/:id/pin", middleware.RequirePermission(permissionChecker, "can_manage_users"), userHandler.UpdatePIN)
	users.Delete("/:id", middleware.RequirePermission(permissionChecker, "can_manage_users"), userHandler.Delete)
	users.Delete("/:id/permanent", middleware.RequirePermission(permissionChecker, "can_manage_users"), userHandler.PermanentDelete)
	...
	expenses.Get("/categories", middleware.RequirePermission(permissionChecker, "can_view_expenses"), expenseHandler.ListCategories)
	expenses.Post("/categories", middleware.RequirePermission(permissionChecker, "can_manage_expenses"), expenseHandler.CreateCategory)
